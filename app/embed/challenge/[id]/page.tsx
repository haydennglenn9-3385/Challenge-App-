    ...
    {isNewYearsChallenge ? (
      <>
        <div>
          ...
          <p>Reps increase by <strong>+5 each week</strong>.</p>
        </div>

        <div>
          <p className="font-semibold text-slate-800 mb-1">🔥 Daily Check-Ins</p>
          <p>Earn <strong>1 point</strong> for 50% and <strong>2 points</strong> for 100%.</p>
        </div>
        ...
        <div>
          ...
          <p>Your points contribute to your team’s total.</p>
        </div>
      ...
      {/* TODAY'S CHECK-IN — ONLY FOR MEMBERS */}
      {
        isMember && (
            ...
            <div className="mt-4 rounded-2xl border border-slate-200 bg-white/80 p-4">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-full text-sm font-semibold transition ${cardioChecked
