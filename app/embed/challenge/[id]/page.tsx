  ...
  if (loading) return (
    <div style={{ minHeight: "100dvh", display: "flex", alignItems: "center", justifyContent: "center" }}>
      <div style={{ textAlign: "center" }}>
        ...
        <p style={{ fontFamily: "'Bebas Neue', cursive", fontSize: 18, color: "#7b2d8b", letterSpacing: 2 }}>LOADING...</p>
      </div>
    </div>
  );
      ...
      <div style={{ padding: "0 20px", maxWidth: 600, margin: "0 auto", display: "flex", flexDirection: "column", gap: 16 }}>
        ...
        <div className="neon-card rounded-3xl overflow-hidden">
          ...
          <div style={{ padding: "20px 24px" }}>
            ...
            <h1 style={{ fontFamily: "'Bebas Neue', cursive", fontSize: 32, color: "#0e0e0e", letterSpacing: 1, lineHeight: 1.1, marginBottom: 8 }}>
              {challenge.name}
            </h1>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 12 }}>
                {[
                  ...
                  <div key={stat.label} style={{ textAlign: "center", padding: "12px 8px", background: "rgba(0,0,0,0.03)", borderRadius: 14 }}>
                    <p style={{ fontFamily: "'Bebas Neue', cursive", fontSize: 22, color: "#0e0e0e", letterSpacing: 0.5, lineHeight: 1 }}>
                      {stat.value}
                    </p>
            ...
            <div style={{ padding: "20px" }}>
              {checkedInToday ? (
                <div style={{ textAlign: "center", padding: "8px 0" }}>
                  ...
                  <p style={{ fontFamily: "'Bebas Neue', cursive", fontSize: 20, color: "#48cfad", letterSpacing: 1 }}>
                    Checked in today!
                  </p>
                ...
                <div>
                  <p style={{ fontFamily: "'Bebas Neue', cursive", fontSize: 20, color: "#0e0e0e", letterSpacing: 1, marginBottom: 12 }}>
                    Today&apos;s Check-in
                  </p>
      ...
      {showEditPanel && (
        ...
        >
          <div className="sheet-panel">
            ...
            <p style={{ fontFamily: "'Bebas Neue', cursive", fontSize: 22, letterSpacing: 1, color: "#0e0e0e", marginBottom: 4 }}>
              Edit Check-ins
            </p>
