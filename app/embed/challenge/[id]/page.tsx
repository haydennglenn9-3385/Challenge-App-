...
export default function ChallengeDetailPage() {
  ...
  // ⭐ NEW: Mobile nav state for Apple-style slide-down menu
  ...
  // ⭐ MOBILE + DESKTOP NAVIGATION (Apple Fitness mobile nav)
  const MobileNav = () => (
    <div className="lg:hidden border-b border-slate-200 pb-3 mb-4">
      ...
      {/* Slide-down menu */}
      {mobileMenuOpen && (
        <div className="mt-3 rounded-2xl border border-slate-200 bg-white/90 apple-slide-down overflow-hidden">
          <div className="flex flex-col py-2">
            <button
              onClick={() => router.push("/")}
              className="px-4 py-3 text-left text-sm hover:bg-slate-100 transition"
            >
              Home
            </button>
  ...
  <div className="space-y-6">
    ...
    {/* ⭐ HERO SECTION — Apple Fitness style on mobile */}
      ...
      <div className="neon-card rounded-3xl p-4">
        ...
        <div className="space-y-3 text-sm text-slate-600">
          <p className="whitespace-pre-line">
            {challenge.rules || "No rules provided."}
          </p>
    ...
    {isMember && (
      <div
        className="
          ...
          sm:grid sm:grid-cols-3 sm:gap-3 sm:overflow-visible sm:px-0
        "
      >
        <div className="min-w-[150px] snap-center rounded-2xl border border-slate-200 bg-white/80 px-4 py-4 text-center shadow-sm sm:min-w-0">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              className="
                ...
                transition-all p-4 text-left disabled:opacity-50
              "
            >
            ...
            <button
              ...
              disabled={checkingIn}
              className="
                rainbow-cta rounded-2xl p-4 text-left
      ...
      <div className="rounded-3xl bg-white/80 border border-slate-200 p-6">
        ...
        <form onSubmit={handleSendMessage} className="mt-4 flex gap-2">
          <input
            ...
            className="
              flex-1 rounded-full border border-slate-200 bg-white/80
              px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-slate-300
            "
            disabled={!userId}
          />
          ...
          {members.map((member) => (
            <div
              ...
              className="
                ...
                rounded-2xl border border-slate-100 bg-white/80
                px-4 py-3
              "
            >
              <div>
      ...
      <div className="rounded-3xl bg-white/80 border border-slate-200 p-6 text-center">
        <button
          ...
          className="
            ...
            border border-red-300 bg-red-50 hover:bg-red-100 transition
          "
        >
          Leave Challenge
        </button>
