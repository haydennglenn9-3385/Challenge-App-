  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <div style={{ fontSize: 9, fontWeight: 700, letterSpacing: 1, textTransform: "uppercase" as const, color: "rgba(255,255,255,0.4)", marginBottom: 4 }}>{challenge.type}</div>
        <div style={{ fontSize: 13, fontWeight: 700, color: "#fff", lineHeight: 1.3, overflow: "hidden", display: "-webkit-box", WebkitLineClamp: 2, WebkitBoxOrient: "vertical" as const }}>
          {challenge.name}
        </div>
      </div>
      <div>
        <div style={{ background: "rgba(255,255,255,0.09)", borderRadius: 10, padding: "8px 10px", marginBottom: 8 }}>
          ...
          <div style={{ fontSize: 9, color: "rgba(255,255,255,0.4)" }}>Members{days !== null ? ` · ${days}d left` : ""}</div>
        </div>
...
export default function HomePage() {
  ...
  if (loading) return (
    <div style={{ minHeight: "100dvh", display: "flex", alignItems: "center", justifyContent: "center", background: "linear-gradient(135deg,#d4f5e2 0%,#fde0ef 30%,#fdf6d3 60%,#d4eaf7 100%)" }}>
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* Full-width page — gradient background, no centering container */
        .page {
          min-height: 100dvh;
          width: 100%;
        ...
        .scroll-area {
          ...
          overflow-y: auto;
          overflow-x: hidden;
          /* extra bottom padding so content clears the nav */
          padding-bottom: 90px;
        }

        /* Action grid — full bleed, no side container */
        .action-grid {
          display: grid;
        ...
        .action-btn:hover { transform: translateY(-3px); box-shadow: 0 6px 18px rgba(0,0,0,0.1); }
        .action-icon {
        ...
        @media (max-width: 340px) {
          ...
          .action-icon { width: 32px; height: 32px; font-size: 15px; }
        }

        /* Frosted glass bottom nav — no hard edge, blends with gradient */
        .bottom-nav {
          position: fixed;
          bottom: 0; left: 0; right: 0;
          /* frosted glass instead of solid black */
      ...
      <div className="page">
        ...
        {/* Rainbow strip — full width */}
        <div style={{
          height: 4, flexShrink: 0, width: "100%",
        ...
        <div className="scroll-area">
          ...
          {/* Hero banner — 16px margin each side, same as everything else */}
          <div style={{
            margin: "0 16px",
            background: "#0e0e0e",
            borderRadius: 22,
            ...
            <div style={{ position: "absolute", bottom: -40, right: -40, width: 180, height: 180, borderRadius: "50%", background: "linear-gradient(135deg,#7b2d8b,#ff3c5f)", opacity: 0.2 }} />
            <div style={{ fontSize: 10, fontWeight: 700, letterSpacing: 2, textTransform: "uppercase", color: "#ffd166", marginBottom: 10 }}>
              ⚡ Welcome back{userEmail ? `, ${userEmail}` : ""}
            </div>
            <div style={{ fontFamily: "'Bebas Neue', cursive", fontSize: 42, lineHeight: 1.0, color: "#fff" }}>
              Building<br />
          ...
          {/* Challenge cards — 16px padding each side, equal to nav width */}
          ...
          {/* Rainbow divider */}
          <div style={{ margin: "20px 16px 0", height: 1.5, background: "linear-gradient(90deg,#ff3c5f,#ff8c42,#ffd166,#06d6a0,#118ab2,#7b2d8b)", opacity: 0.3, borderRadius: 2 }} />
          ...
          {/* Post input — full width, always visible */}
          <div style={{ padding: "10px 16px 12px", display: "flex", gap: 8 }}>
            <input
              ...
              style={{
                flex: 1, fontSize: 13, padding: "11px 16px",
            ...
            <button
              ...
              style={{
                background: posting || !postText.trim() ? "rgba(14,14,14,0.25)" : "#0e0e0e",
          ...
          {([
            ...
            <div
              ...
              style={{
                ...
                gap: 4, cursor: "pointer", padding: "6px 16px", borderRadius: 12,
                background: activeNav === nav.id ? "rgba(255,255,255,0.1)" : "transparent",
            ...
            >
              {nav.id === "dashboard" ? (
                <div style={{
                  width: 34, height: 34,
                  background: activeNav === "dashboard"
                    ? "linear-gradient(135deg,#7b2d8b,#ff3c5f)"
                    : "rgba(255,255,255,0.12)",
                  borderRadius: 10,
                  display: "flex", alignItems: "center", justifyContent: "center",
                  fontSize: 19, transition: "background 0.15s",
                }}>
                  🏳️‍🌈
                </div>
              ) : (
              ...
              <div style={{
                ...
                color: activeNav === nav.id ? "#ffd166" : "rgba(255,255,255,0.5)",
              }}>
                {nav.label}
              </div>
            </div>
