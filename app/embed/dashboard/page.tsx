...
export default function DashboardPage() {
  ...
  useEffect(() => {
    async function load() {
      ...
      // No join — emoji_avatar is a direct column on activity_feed
        ...
        <div className="page-padding" style={{ width: "100%", flex: 1, overflowY: "auto", paddingBottom: 112 }}>
          ...
          <div style={{ background: "#0e0e0e", borderRadius: 22, padding: "24px 22px", position: "relative", overflow: "hidden", boxShadow: "0 8px 32px rgba(0,0,0,0.18)" }}>
            ...
            <a href="https://queersandalliesfitness.com" target="_blank" rel="noopener noreferrer" style={{ textDecoration: "none" }}>
              <div style={{ fontSize: 40, fontWeight: 900, letterSpacing: "-0.03em", lineHeight: 1.0, color: "#fff" }}>
                Building<br />
            ...
            <div style={{ fontSize: 12, color: "rgba(255,255,255,0.5)", marginTop: 10, fontWeight: 500 }}>Physical Fitness + Mental Health · Sacramento, CA</div>
            <button
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "4px 0 12px" }}>
            <div style={{ fontSize: 22, fontWeight: 700, letterSpacing: "-0.01em" }}>Featured Challenges</div>
            <div style={{ fontSize: 12, fontWeight: 600, color: "#7b2d8b", cursor: "pointer" }} onClick={() => router.push("/embed/challenges")}>See all →</div>
          </div>
            ...
            {!authed && (
              <div className="feed-blur-overlay">
                <div className="feed-auth-card">
                  ...
                  <div style={{ fontSize: 20, fontWeight: 700, color: "#0e0e0e" }}>Join the Community</div>
